  ...
  return (
    loading ? <Loader /> :
      <>
          ...
          <div className='flex flex-wrap gap-4 m-6'>
            {
              photographyData.map((item, index) => (
                <div key={index} className='p-4 rounded-lg shadow-md flex flex-col justify-center items-center bg-[#b52323] border hover:scale-105 transition-transform duration-300 ease-in-out'>
                  ...
                  <img src={item.file} alt="photograph" className='w-full rounded-lg' />
                </div>
              ))
            }
          </div>
        ...
        {
          photographyData.length === 0 && <p className='text-red-400'>No photographs found.</p>
        }
        ...
        {
          artData.length === 0 && <p className='text-red-400'>No Artwork found.</p>
        }
        ...
        {
          poemData.length === 0 && <p className='text-red-400'>No poem found.</p>
        }
          ...
          <div className='flex flex-wrap gap-4 m-6'>
            {
              contactData.map((item, index) => (
                <div key={index} className='p-4 rounded-lg shadow-md bg-[#b52323] border hover:scale-105 transition-transform duration-300 ease-in-out'>
                  <h2 className='text-lg font-semibold text-red-100'>{item.name}</h2>
                  <p className='text-red-100'>{item.email}</p>
        ...
        {
          contactData.length === 0 && <p className='text-red-400'>No contact form submissions found.</p>
        }
      </>
  )
}
