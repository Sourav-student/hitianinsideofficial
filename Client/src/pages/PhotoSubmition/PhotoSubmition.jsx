...
import { photoFormSubmit } from '../../api/api';
...
const ArtSubmition = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await photoFormSubmit(formData);
      setSubmitting(false);
  ...
  return (
    <>
      <h1 className='text-white text-2xl m-4'>Submit your Photograph here and be the part of our Almanac</h1>
